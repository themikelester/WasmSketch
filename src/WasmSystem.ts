//----------------------------------------------------------------------------------------------------------------------
// Notes:  A Typescript WASI (WAsm System Interface) implementation based on https://github.com/qrdate/tinywasi.  
//
// Author: Mike Lester
// Date C: 2025-04-04
//----------------------------------------------------------------------------------------------------------------------
export class WASI {
    ...
    private nameSpaces: { [key: string]: { [key: string]: CallableFunction | undefined } } = {
        wasi_snapshot_preview1: {
            ...
            random_get: undefined, // ((param i32 i32) (result i32))
    ...
    public get imports(): WebAssembly.Imports {
